...
void engine::shader::setMat4(uint32_t program, const char *name, const glm::mat4 &data) {
    assert(name != nullptr);
...
void engine::shader::setVec3(uint32_t program, const char *name, const glm::vec3 &data) {
    assert(name != nullptr);
